...
void laxMPC_ADMM(double *x0_in, double *xr_in, double *ur_in, double *u_opt, int *k_in, int *e_flag, solution *sol){
    ...
    // Constant variables
    const static double LB[4] = { -1.570796326794897, -4.000000000000000, -60.000000000000000, -100.000000000000000 };
const static double UB[4] = { 1.570796326794897, 4.000000000000000, 60.000000000000000, 100.000000000000000 };
const static double Hi[0][4] = {  };
const static double Hi_0[1] = { 0.066225165562914 };
const static double Hi_N[3][3] = { {0.000822706150096, -0.006309180404356, -0.000591719853410}, {-0.006309180404356, 0.051666805505601, -0.000768874113613}, {-0.000591719853410, -0.000768874113613, 0.014150069360998} };
const static double Q[3] = { -10.000000000000000, -1.000000000000000, -10.000000000000000 };
const static double R[1] = { -0.100000000000000 };
const static double AB[3][4] = { {1.013152476396764, 0.020087606532382, 0.000000000000000, -0.000143622254477}, {1.318123211255288, 1.013152476396764, 0.000000000000000, -0.014393626079830}, {0.000000000000000, 0.000000000000000, 1.000000000000000, 0.020000000000000} };
const static double Alpha[0][3][3] = {  };
const static double Beta[3][3] = { {34.864004383737075, -0.219958520265987, -0.020636355678341}, {0.000000000000000, 17.410997049014608, -0.092749787700522}, {0.000000000000000, 0.000000000000000, 13.937127060281002} };
const static double T[3][3] = { {-52539.974900311273814, -6455.562405372145804, -2548.491879882645662}, {-6455.562405372145804, -797.336026379678174, -314.095179962474276}, {-2548.491879882645662, -314.095179962474276, -179.309499446189022} };
